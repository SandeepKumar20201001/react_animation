...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="1" data-scroll-section-inview id='Contact' className=' w-full bg-[#F1F1F1]'>
      <div className=' w-full h-screen py-10 px-10 flex'>
        <div className=' w-1/2 h-2/3 text-[18vh] leading-[14vh] mt-[8vh] font-bold font-bebas'>
          <h1>EYE-</h1>
          <h1>OPENING</h1>
        </div>

        <div className='w-1/2 h-2/3'>
          <h1 className=' text-[18vh] font-bold font-bebas'>PRESENTATIONS</h1>
          <div className='flex justify-between'>
            ...
            <div className='left_part'>
              ...
              <div>
                <p>P:</p>
                <div className="link flex flex-col mt-5 underline">
                  <a target='_blank' href="https://www.instagram.com/sandeep_web_developer/">Instagram</a>
                  <a href="">Behance</a>
                  <a href="">Facebook</a>
              ...
              <div className=' mt-10'>
                ...
                <div className="link flex flex-col mt-5 underline">
                  ...
                  <p>Triveni Apartments</p>
                  <p className=' mt-5'>Pitampur</p>
                  <p>New Delhi , India</p>
                </div>
              </div>
              ...
              <div className=' mt-10'>
                <p>E:</p>
                <div className="link flex flex-col mt-5 underline">
                  <a class="link link--underline" href="mailto:sikkimdiaries53@gmail.com">
                    hello@ochi.design </a>
                </div>
              </div>
            ...
            <div className='right_part mr-[5vh] flex items-center'>
              <div className=' mt-16'>
                <p>M:</p>
                <div className="link flex flex-col mt-5 underline">
                  <a href="/">Home</a>
      ...
      <div className=' px-5 mt-1 mb-10 py-10 flex items-center justify-between'>
        <div className="logo relative ml-14 h-14 w-14 overflow-hidden rounded-full">
        <a href="/">
                    <img className=' w-full bg-blue-400' src="../src/images/logo.jpg " alt="" />
                </a>
        </div>
        {/* <div className=''><svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className=' opacity-40 pl-[35vh]'>
          © ochi design 2024.
          <a className=' underline' href="">Legal Terms</a>
        </div>

        <div className=' opacity-40'>
          <a class="link" target="_blank">Website by Obys</a>
        </div>
      </div>
